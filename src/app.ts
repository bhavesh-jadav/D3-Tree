import { D3Tree, TreeNodeShapeProperties, TreeNodeShapeTypes, TreeGeneralProperties, TreeOrientation, TreeNodeLinkProperties, TreeNodeLinkTypes, TreeNodeTextProperties } from './D3Tree';
...
let d3Tree = new D3Tree(rootSVG, data);
...
d3Tree.CreateTree(treeGeneralProperties);

//add node shapes
let nodeShapeProperties: TreeNodeShapeProperties = {
...
d3Tree.CreateNodeShape(nodeShapeProperties);
...
d3Tree.CreateNodeText(treeGeneralProperties, nodeShapeProperties, treeNodeTextProperties);
